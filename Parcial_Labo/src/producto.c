...
int prod_cargaForzada(Producto* list, int length)
{
	...
	if(list != NULL)
	{
		if(length >0)
		{
			...
			strncpy(prodAux[1].nombre,"Zapas Adidas",PROD_NOMBRE_LEN);
			prodAux[1].categoria = 1;
			prodAux[1].stock = 1;
			prodAux[1].precio = 4000;
			prodAux[1].idProd = prod_generateID();
			prodAux[1].FK_userVendedorIDD = 1001;
			strncpy(prodAux[1].FK_userVendedor,"Gonzalo",NOMBRE_LEN);
			prodAux[1].isEmpty = OCUPADO;

			strncpy(prodAux[2].nombre,"Zapas Puma",PROD_NOMBRE_LEN);
			prodAux[2].categoria = 1;
			prodAux[2].stock = 0;
			prodAux[2].precio = 3000;
			prodAux[2].idProd = prod_generateID();
			prodAux[2].FK_userVendedorIDD = 1001;
			strncpy(prodAux[2].FK_userVendedor,"Gonzalo",NOMBRE_LEN);
			prodAux[2].isEmpty = OCUPADO;

			strncpy(prodAux[3].nombre,"Celular Samsung a20",PROD_NOMBRE_LEN);
			prodAux[3].categoria = 2;
			prodAux[3].stock = 1;
			prodAux[3].precio = 50000;
			prodAux[3].idProd = prod_generateID();
			prodAux[3].FK_userVendedorIDD = 1002;
			strncpy(prodAux[3].FK_userVendedor,"Agostina",NOMBRE_LEN);
			prodAux[3].isEmpty = OCUPADO;

			strncpy(prodAux[4].nombre,"Celular iPhone 13",PROD_NOMBRE_LEN);
			prodAux[4].categoria = 2;
			prodAux[4].stock = 10;
			prodAux[4].precio = 70000;
			prodAux[4].idProd = prod_generateID();
			prodAux[4].FK_userVendedorIDD = 1002;
			strncpy(prodAux[4].FK_userVendedor,"Agostina",NOMBRE_LEN);
			prodAux[4].isEmpty = OCUPADO;

			strncpy(prodAux[5].nombre,"Papas de tubo Lays",PROD_NOMBRE_LEN);
			prodAux[5].categoria = 3;
			prodAux[5].stock = 20;
			prodAux[5].precio = 70;
			prodAux[5].idProd = prod_generateID();
			strncpy(prodAux[5].FK_userVendedor,"Ivan",NOMBRE_LEN);
			prodAux[5].FK_userVendedorIDD = 1003;
			prodAux[5].isEmpty = OCUPADO;

			strncpy(prodAux[6].nombre,"Destornillador Philips",PROD_NOMBRE_LEN);
			prodAux[6].categoria = 4;
			prodAux[6].stock = 1;
			prodAux[6].precio = 200;
			prodAux[6].idProd = prod_generateID();
			prodAux[6].FK_userVendedorIDD = 1004;
			strncpy(prodAux[6].FK_userVendedor,"Micaela",NOMBRE_LEN);
			prodAux[6].isEmpty = OCUPADO;

			strncpy(prodAux[7].nombre,"Colgate 3x accion",PROD_NOMBRE_LEN);
			prodAux[7].categoria = 5;
			prodAux[7].stock = 10;
			prodAux[7].precio = 200;
			prodAux[7].idProd = prod_generateID();
			prodAux[7].FK_userVendedorIDD = 1005;
			strncpy(prodAux[7].FK_userVendedor,"Juan",NOMBRE_LEN);
			prodAux[7].isEmpty = OCUPADO;

			strncpy(prodAux[8].nombre,"Jabon blanco",PROD_NOMBRE_LEN);
			prodAux[8].categoria = 5;
			prodAux[8].stock = 0;
			prodAux[8].precio = 90;
			prodAux[8].idProd = prod_generateID();
			prodAux[8].FK_userVendedorIDD = 1005;
			strncpy(prodAux[8].FK_userVendedor,"Juan",NOMBRE_LEN);
			prodAux[8].isEmpty = OCUPADO;

			strncpy(prodAux[9].nombre,"Detergente",PROD_NOMBRE_LEN);
			prodAux[9].categoria = 5;
			prodAux[9].stock = 30;
			prodAux[9].precio = 300;
			...
			strncpy(prodAux[10].nombre,"Medias NIKE",PROD_NOMBRE_LEN);
			prodAux[10].categoria = 1;
			prodAux[10].stock = 15;
			prodAux[10].precio = 300;
			prodAux[10].idProd = prod_generateID();
			prodAux[10].FK_userVendedorIDD = 1001;
			strncpy(prodAux[10].FK_userVendedor,"Gonzalo",NOMBRE_LEN);
			prodAux[10].isEmpty = OCUPADO;

			strncpy(prodAux[11].nombre,"Celular Xiomi Redmi 12",PROD_NOMBRE_LEN);
			prodAux[11].categoria = 2;
			prodAux[11].stock = 3;
			prodAux[11].precio = 60000;
			prodAux[11].idProd = prod_generateID();
			prodAux[11].FK_userVendedorIDD = 1002;
			strncpy(prodAux[11].FK_userVendedor,"Agostina",NOMBRE_LEN);
			prodAux[11].isEmpty = OCUPADO;

			strncpy(prodAux[12].nombre,"Pantalon Adidas",PROD_NOMBRE_LEN);
			prodAux[12].categoria = 1;
			prodAux[12].stock = 20;
			prodAux[12].precio = 3000;
